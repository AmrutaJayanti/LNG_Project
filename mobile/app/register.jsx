...
const Register = () => {
  ...
  const register = async () => {
    ...
    setLoading(true);
    try {
      const res = await postData(`${API_BASE_URL}/auth/register`, {
        email,
        password,
        ...
        <View style={styles.glass}>
          ...
          >
            <Text style={styles.loginRedirectText}>
              Already have an account? <Text style={styles.loginRedirectLink}>Go to Login</Text>
            </Text>
          </TouchableOpacity>
        </View>
      </KeyboardAvoidingView>
